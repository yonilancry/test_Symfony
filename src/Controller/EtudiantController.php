...
class EtudiantController extends AbstractController
{
    ...
    #[Route('/sexe', name: 'app_etudiant_sexe', methods: ['GET', 'POST'])]
    public function filter(EtudiantRepository $etudiantRepository, Request $request): Response

    {
        $sexeTab=[0=>"Non binaire",2=>"Femme",1=>"Femme"];
        return $this->render('etudiant/sexe.html.twig', [
            'etudiants' => $etudiantRepository->findBy(['sexe'=>$request->request->get("sexe")]),
            'sexeTab'=>$sexeTab
        ]);
    }
